...
reduced_data %>%
  ...
  theme(legend.title = element_blank())
```
```{r fig5, echo=FALSE, fig.cap = "Distribution of religion of survey respondents by family income"}
reduced_data %>%
...
```{r fig6, echo=FALSE, fig.cap = "Survey respondents' opinion on governmemt policy on improving coditions of black population"}
reduced_data %>%
  drop_na(nation_race) %>%
  ...
  theme(legend.title = element_blank())
```
```{r fig7, echo=FALSE, fig.cap = "Distribution of religion of survey respondents"}
reduced_data %>%
  ...
  labs(x = element_blank(),
       y = element_blank(),
       title = "Is the Government spending enough on coditions of Black People?",
       ) +
  coord_flip() +
  theme(legend.title = element_blank())
```
